...
@Configuration
@EnableReactiveMongoRepositories({"org.springframework.cloud.sample.bookstore.servicebroker.repository",
		"org.springframework.cloud.sample.bookstore.web.repository"})
